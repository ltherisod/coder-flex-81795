...
2. Muevase a la carpeta creada con el comando `cd coder-flex-81795 `
3. Ejecute el comando `npm install` para instalar dependencias y crar la carpeta `node_modules`
...
Si desea ver el proyecto online, puede ingresar al sliguiente link: [Coder Flex App](https://coder-flex-81795.vercel.app/)
